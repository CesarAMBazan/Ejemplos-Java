...
public class inicio
{
    ...
    public static void maquina(List<Moneda> bolsa){
        ...
        System.out.println("Real: "+real+"\nFayuca: "+fayuca); // Se imprimen cuantas monedas reales se tuvieron y las fayucas
    }
    
    /*Función isReal que regresa una expresión booleana de acuerdo si la moneda es real o falsa*/
    public static boolean isReal(Moneda moneda){
        if(moneda.getPeso() == 10.329) return true;
        else return false;
    }
}